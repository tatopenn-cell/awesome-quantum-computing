...
- [Dense-Evolution](https://github.com/tatopenn-cell/Dense-Evolution) - High-performance NISQ statevector simulator with JAX JIT/XLA compilation, optional GPU acceleration, and built-in zero-noise-extrapolation error mitigation.
